...
public class ModifierCoating extends ModifierTrait {
  
  public static final String EXTRA_TRAIT_IDENTIFIER = "extratrait";

  public ModifierCoating() {
    super("ticunlimitedtraits.coating", 0x777777, 32767, 1);
  ...
  private static class CoatingAspect extends ModifierAspect {
    ...
    public boolean canApply(ItemStack stack, ItemStack original) throws TinkerGuiException {
      ...
      throw new TinkerGuiException(Util.translate("gui.error.ticunlimitedtraits.coating_no_extratrait"));
    }
